 ...
 * @author Author
 */
public class Animationscartpushagain {
	...
	public static final AnimationDefinition move2 = AnimationDefinition.Builder.withLength(0.0F).looping()

			.build();

	public static final AnimationDefinition animation2 = AnimationDefinition.Builder.withLength(1.0F)
			.addAnimation("leftWheel",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(0.3333F, KeyframeAnimations.degreeVec(90.0F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(0.6667F, KeyframeAnimations.degreeVec(180.0F, 0.0F, 0.0F),
									AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition animation3 = AnimationDefinition.Builder.withLength(0.0F)
