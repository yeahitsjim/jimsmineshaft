...
public class ModelcartRocks4test<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cartRocks4test"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hold = main.addOrReplaceChild("hold",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(6.0F, -3.0F, 2.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(6, 2)
						.addBox(3.0F, -6.0F, -11.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(6, 2)
						.addBox(-2.0F, -5.0F, 4.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 8.0F, 0.0F));

		PartDefinition cube_r1 = hold.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(2, 1).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -2.0F, 10.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition cube_r2 = hold.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(2, 1).addBox(-3.0F, -1.0F, -1.0F, 3.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -3.0F, 3.0F, 0.0F, -0.0436F, 0.0F));

		PartDefinition cube_r3 = hold.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(3, 2).addBox(-3.0F, -1.0F, -1.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 3.0F, 0.0F, -0.0436F, 0.0F));

		PartDefinition cube_r4 = hold
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(3, 2).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -2.0F, 4.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition cube_r5 = hold.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(1, 1).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.0F, 2.0F, 0.0F, -0.2182F, 0.0F));
		...
		PartDefinition cube_r9 = hold.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(11, 4).addBox(-4.0F, -4.0F, -4.0F, 4.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -4.0F, -1.0F, 0.0F, -0.5236F, 0.0F));

		PartDefinition cube_r10 = hold
				.addOrReplaceChild("cube_r10",
						CubeListBuilder.create().texOffs(2, 6).addBox(-5.0F, -1.0F, -4.0F, 5.0F, 1.0F, 5.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(6.0F, -3.0F, 0.0F, 0.0F, 0.1745F, 0.0F));
		...
		PartDefinition cube_r14 = hold.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(1, 0).addBox(-5.0F, -1.0F, -5.0F, 5.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -2.0F, 7.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition cube_r15 = hold.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(1, 0).addBox(-4.0F, -1.0F, -1.0F, 4.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = hold.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(-3, -3)
						.addBox(-5.0F, -2.0F, -1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(1, 0)
						.addBox(-4.0F, 0.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -4.0F, 5.0F, 0.0F, 1.2217F, 0.0F));

		PartDefinition cube_r17 = hold.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(2, 3).addBox(-4.0F, -1.0F, -1.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -3.0F, 7.0F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r18 = hold.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(1, 1).addBox(-3.0F, -1.0F, -6.0F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -4.0F, 13.0F, 0.0F, -0.2618F, 0.0F));

		PartDefinition cube_r19 = hold.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(1, 1).addBox(-3.0F, -1.0F, -6.0F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = hold.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(6, 0)
						.addBox(-2.0F, -1.0F, -6.0F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(1, 2)
						.addBox(-4.0F, 0.0F, -1.0F, 6.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -4.0F, 9.0F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r21 = hold
				.addOrReplaceChild("cube_r21",
						CubeListBuilder.create().texOffs(1, 2).addBox(-4.0F, -1.0F, -1.0F, 4.0F, 1.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.0F, -3.0F, 9.0F, 0.0F, 0.3054F, 0.0F));
		...
		PartDefinition cube_r25 = hold.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r28 = hold.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(2, 1).addBox(-4.0F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.0F, -2.0F, 0.0F, 0.0F, -0.9163F, 0.0F));

		PartDefinition cube_r29 = hold.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(2, 1).addBox(-4.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r38 = hold.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(1, 3).addBox(-4.0F, -1.0F, -2.0F, 4.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r40 = hold.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(3, 4).addBox(-4.0F, -1.0F, -2.0F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
