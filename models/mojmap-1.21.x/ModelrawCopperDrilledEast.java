...
public class ModelrawCopperDrilledEast<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-8.0F, -7.0F, -8.0F, 16.0F, 7.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 23)
						.addBox(-8.0F, -16.0F, -8.0F, 16.0F, 7.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(64, 0).addBox(-2.0F, -6.0F, -1.0F, 1.0F, 6.0F, 11.0F,
		...
		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 64).addBox(-2.0F, -8.0F, -1.0F, 1.0F, 6.0F, 11.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = bone.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(46, 46).addBox(-7.0F, -9.0F, 0.0F, 7.0F, 2.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, 0.0F, -1.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r30 = bone
				.addOrReplaceChild("cube_r30",
						CubeListBuilder.create().texOffs(0, 46).addBox(-16.0F, -9.0F, -16.0F, 7.0F, 2.0F, 16.0F,
								new CubeDeformation(0.0F)),
