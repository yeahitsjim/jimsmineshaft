...
public class ModelcartPhase6<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cartPhase6"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r4 = hold.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 2).addBox(-4.0F, -1.0F, -1.0F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -3.0F, 11.0F, 0.0F, -0.829F, 0.0F));
		...
		PartDefinition cube_r34 = hold.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(0, 2).addBox(-5.0F, -1.0F, -2.0F, 5.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, -3.0F, -2.0F, 0.0F, -0.3054F, 0.0F));

		PartDefinition cube_r35 = hold
