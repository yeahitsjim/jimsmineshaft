...
public class ModelcartVariant1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cartvariant1"), "main");
	...
	public ModelcartVariant1(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hold = main.addOrReplaceChild("hold",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(-8.0F, -9.0F, -14.0F, 1.0F, 1.0F, 28.0F, new CubeDeformation(0.0F)).texOffs(3, 0)
		...
		PartDefinition cube_r6 = hold.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(-1, 0).addBox(-3.0F, -1.0F, -5.0F, 3.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
