...
public class ModelcartPhase5<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cartphase5"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = hold.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(1, 3).addBox(-3.0F, -1.0F, -2.0F, 3.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, -3.0F, 9.0F, 0.0F, -0.3491F, 0.0F));
		...
		PartDefinition cube_r4 = hold.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(-1, 2).addBox(-5.0F, -1.0F, -1.0F, 5.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 12.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition cube_r5 = hold
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(1, 1).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -3.0F, 7.0F, 0.0F, 0.0873F, 0.0F));
		...
		PartDefinition cube_r11 = hold.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -1.0F, -5.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(3, 3)
						.addBox(-2.0F, -2.0F, -6.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -2.0F, -3.0F, 0.0F, 0.3927F, 0.0F));

		PartDefinition cube_r12 = hold.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(16, 5).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -3.0F, -1.0F, 0.0F, 0.3927F, 0.0F));

		PartDefinition cube_r13 = hold.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(2, 3).addBox(-3.0F, -3.0F, -6.0F, 2.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = hold.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(-2, -2).addBox(-4.0F, -1.0F, -3.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = hold.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(1, 0).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = hold
				.addOrReplaceChild("cube_r34",
						CubeListBuilder.create().texOffs(0, 1).addBox(-6.0F, -2.0F, -2.0F, 3.0F, 2.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(6.0F, -3.0F, 3.0F, 0.0F, 0.1309F, 0.0F));
