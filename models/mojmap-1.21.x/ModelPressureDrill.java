...
public class ModelPressureDrill<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pressuredrill"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = main.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 4)
						.addBox(-32.0F, 0.0F, -1.0F, 17.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 8)
						.addBox(-24.0F, 2.0F, -3.0F, 9.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						.addBox(-28.0F, 2.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
						.addBox(-32.0F, 2.0F, -4.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
						.addBox(-32.0F, 0.0F, -2.0F, 17.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						.addBox(-32.0F, 0.0F, 1.0F, 17.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
