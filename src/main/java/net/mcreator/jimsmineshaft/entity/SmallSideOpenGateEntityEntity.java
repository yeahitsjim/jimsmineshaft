...
import net.mcreator.jimsmineshaft.procedures.SmallSideOpenGateEntityPlaybackConditionProcedure;
import net.mcreator.jimsmineshaft.procedures.SmallSideOpenGateEntityPlaybackConditio1nProcedure;
import net.mcreator.jimsmineshaft.procedures.SmallSideOpenGateEntityPlaybackCon1ditionProcedure;
import net.mcreator.jimsmineshaft.procedures.SmallSideOpenGateEntityPlaybackCo1nditionProcedure;
import net.mcreator.jimsmineshaft.procedures.SmallSideOpenGateEntityOnEntityTickUpdateProcedure;
...
public class SmallSideOpenGateEntityEntity extends PathfinderMob {
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(SmallSideOpenGateEntityPlaybackConditio1nProcedure.execute(this), this.tickCount);
			this.animationState1.animateWhen(SmallSideOpenGateEntityPlaybackConditionProcedure.execute(this), this.tickCount);
			this.animationState2.animateWhen(SmallSideOpenGateEntityPlaybackCo1nditionProcedure.execute(this), this.tickCount);
	...
	public void baseTick() {
		super.baseTick();
		SmallSideOpenGateEntityOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
