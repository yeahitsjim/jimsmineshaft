...
public class BulletProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public BulletProjectileEntity(EntityType<? extends BulletProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public BulletProjectileEntity(EntityType<? extends BulletProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static BulletProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BulletProjectileEntity entityarrow = new BulletProjectileEntity(JimsmineshaftModEntities.BULLET_PROJECTILE.get(), entity, world, null);
	...
	public static BulletProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		BulletProjectileEntity entityarrow = new BulletProjectileEntity(JimsmineshaftModEntities.BULLET_PROJECTILE.get(), entity, entity.level(), null);
