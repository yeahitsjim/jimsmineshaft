...
public class StalkerEntity extends Monster {
	...
	public static final EntityDataAccessor<Integer> DATA_faceDir = SynchedEntityData.defineId(StalkerEntity.class, EntityDataSerializers.INT);
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		compound.putInt("DatafaceDir", this.entityData.get(DATA_faceDir));
	}
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("DatafaceDir"))
			this.entityData.set(DATA_faceDir, compound.getInt("DatafaceDir"));
	}
