...
import net.mcreator.jimsmineshaft.procedures.StalkerNaturalEntitySpawningConditionProcedure;
...
public class StalkerEntity extends Monster {
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			...
			this.animationState6.animateWhen(StalkerPlaybackConditionImpaleFailProcedure.execute(this), this.tickCount);
		}
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(JimsmineshaftModEntities.STALKER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return StalkerNaturalEntitySpawningConditionProcedure.execute(world, x, y, z);
