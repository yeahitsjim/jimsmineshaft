...
public class Cart4Entity extends PathfinderMob {
	public Cart4Entity(EntityType<Cart4Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("The Cart 4");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(Cart4Entity.this.getId());
