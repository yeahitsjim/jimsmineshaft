...
import net.mcreator.jimsmineshaft.procedures.ElevatorTickEvent2Procedure;
...
public class ElevatorEntity extends PathfinderMob {
	...
	public ElevatorEntity(EntityType<ElevatorEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public boolean hurtServer(ServerLevel level, DamageSource damagesource, float amount) {
		...
		ElevatorEntityIsHurtProcedure.execute(entity, sourceentity);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ElevatorRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ElevatorTickEvent2Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
