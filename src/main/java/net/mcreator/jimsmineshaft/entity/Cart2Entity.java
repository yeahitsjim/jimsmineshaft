...
public class Cart2Entity extends PathfinderMob {
	public Cart2Entity(EntityType<Cart2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("The Cart 2");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(Cart2Entity.this.getId());
