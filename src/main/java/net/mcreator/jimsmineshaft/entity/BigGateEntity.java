...
public class BigGateEntity extends PathfinderMob {
	public static final EntityDataAccessor<Boolean> DATA_open = SynchedEntityData.defineId(BigGateEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_opening = SynchedEntityData.defineId(BigGateEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_opening2 = SynchedEntityData.defineId(BigGateEntity.class, EntityDataSerializers.BOOLEAN);
