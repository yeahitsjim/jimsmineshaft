package net.mcreator.jimsmineshaft;
...
@Mod("jimsmineshaft")
public class JimsmineshaftMod {
	public static final Logger LOGGER = LogManager.getLogger(JimsmineshaftMod.class);
	public static final String MODID = "jimsmineshaft";

	public JimsmineshaftMod(IEventBus modEventBus) {
		...
		JimsmineshaftModBlockEntities.REGISTRY.register(modEventBus);
