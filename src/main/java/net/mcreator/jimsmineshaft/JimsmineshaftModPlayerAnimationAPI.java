...
import net.mcreator.jimsmineshaft.network.LoadPlayerAnimationMessage;
...
public class JimsmineshaftModPlayerAnimationAPI {
	...
	private static class AnimationLoader {
		...
		public static void loadAnimations(PlayerEvent.PlayerLoggedInEvent event) {
			if (JimsmineshaftModPlayerAnimationAPI.initialized.get(event.getEntity().getUUID()) == null) {
				if (event.getEntity() instanceof ServerPlayer player) {
					...
					JimsmineshaftModPlayerAnimationAPI.initialized.put(player.getUUID(), true);
				}
			}
		}
