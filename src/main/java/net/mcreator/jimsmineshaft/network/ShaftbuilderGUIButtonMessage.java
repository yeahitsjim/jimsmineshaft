...
public record ShaftbuilderGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			SetShaftmainlitProcedure.execute();
		}
		if (buttonID == 1) {

			SetShaftmainnonlitProcedure.execute();
		}
		if (buttonID == 2) {

			SetShaftmainbitProcedure.execute();
		}
		if (buttonID == 8) {

			SetShaftBbit1Procedure.execute();
		}
		if (buttonID == 9) {

			SetShaftBbit2Procedure.execute();
		}
		if (buttonID == 10) {

			SetShaftBbit3Procedure.execute();
		}
		if (buttonID == 11) {

			SetShaftBbit4Procedure.execute();
		}
		if (buttonID == 12) {

			SetShaftC1Procedure.execute();
		}
		if (buttonID == 13) {

			SetShaftC2Procedure.execute();
		}
		if (buttonID == 14) {

			SetShaftC3Procedure.execute();
		}
		if (buttonID == 15) {

			SetShaftC4Procedure.execute();
		}
		if (buttonID == 16) {

			SetShaftC5Procedure.execute();
		}
		if (buttonID == 17) {

			SetShaftCbit1Procedure.execute();
		}
		if (buttonID == 18) {

			SetShaftCbit2Procedure.execute();
		}
		if (buttonID == 19) {

			SetShaftCbit3Procedure.execute();
		}
		if (buttonID == 20) {

			SetShaftCbit4Procedure.execute();
		}
		if (buttonID == 21) {
		...
		if (buttonID == 22) {
			...
			SetShaftBRoom1Procedure.execute();
		}
		if (buttonID == 23) {

			SetShaftBRoom2Procedure.execute();
		}
	}
