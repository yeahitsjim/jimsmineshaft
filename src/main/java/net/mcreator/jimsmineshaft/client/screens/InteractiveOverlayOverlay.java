	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (OverlayDisplayProcedure.execute(entity)) {
			if (InteractdisplayProcedure.execute(world, x, y, z)) {
				event.getGuiGraphics().blit(RenderType::guiTextured, ResourceLocation.parse("jimsmineshaft:textures/screens/e.png"), w / 2 + -8, h - 69, 0, 0, 16, 16, 16, 16);
			}
			...
			if (Staminabar10Procedure.execute(entity)) {
				event.getGuiGraphics().blit(RenderType::guiTextured, ResourceLocation.parse("jimsmineshaft:textures/screens/rightstaminabarrrrr.png"), 87, h - 16, 0, 0, 9, 10, 9, 10);
			}
