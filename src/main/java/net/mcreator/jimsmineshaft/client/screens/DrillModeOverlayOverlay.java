...
import net.mcreator.jimsmineshaft.procedures.DrillModeOverlayDisplayOverlayIngameProcedure;
...
public class DrillModeOverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (DrillModeOverlayDisplayOverlayIngameProcedure.execute(entity)) {
