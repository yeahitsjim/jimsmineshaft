...
public class Modelbiggate extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("jimsmineshaft", "modelbiggate"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightdoor = partdefinition.addOrReplaceChild("rightdoor",
				CubeListBuilder.create().texOffs(32, 16).addBox(-39.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 102).addBox(-39.0F, -54.0F, -2.0F, 42.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 22)
						.addBox(-38.5F, -32.0F, -1.5F, 41.5F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(104, 16).addBox(-39.0F, 30.0F, -2.0F, 40.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(104, 53)
						.addBox(-40.0F, 31.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 16).addBox(-33.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(56, 16)
						.addBox(-27.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(68, 16).addBox(-21.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 16)
						.addBox(-15.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(92, 16).addBox(-9.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 102)
						.addBox(-3.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(39.0F, -7.75F, 0.0F));
		PartDefinition leftdoor = partdefinition.addOrReplaceChild("leftdoor", CubeListBuilder.create().texOffs(32, 16).mirror().addBox(37.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(44, 102).mirror()
				.addBox(-3.0F, -54.0F, -2.0F, 42.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(104, 22).mirror().addBox(-3.0F, -32.0F, -1.5F, 41.5F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(104, 16).mirror()
				.addBox(-1.0F, 30.0F, -2.0F, 40.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(104, 53).mirror().addBox(36.0F, 31.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(44, 16).mirror()
				.addBox(31.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(56, 16).mirror().addBox(25.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(68, 16).mirror()
				.addBox(19.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(80, 16).mirror().addBox(13.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(92, 16).mirror()
				.addBox(7.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(32, 102).mirror().addBox(1.0F, -52.0F, -2.0F, 2.0F, 82.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-39.0F, -7.75F, 0.0F));
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(39.0F, -7.75F, 0.0F));
		PartDefinition frame = bone.addOrReplaceChild("frame", CubeListBuilder.create().texOffs(0, 16).addBox(40.0F, -9.5805F, -2.3333F, 8.0F, 88.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 16).mirror()
				.addBox(-48.0F, -9.5805F, -2.3333F, 8.0F, 88.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-39.0F, -46.4195F, -1.6667F));
