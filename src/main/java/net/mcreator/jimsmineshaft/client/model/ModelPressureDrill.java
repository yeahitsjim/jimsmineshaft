...
public class ModelPressureDrill extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("jimsmineshaft", "model_pressure_drill"), "main");
	...
	public ModelPressureDrill(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = main.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 4).addBox(-32.0F, 0.0F, -1.0F, 17.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 8).addBox(-24.0F, 2.0F, -3.0F, 9.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 20)
						.addBox(-28.0F, 2.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 20).addBox(-32.0F, 2.0F, -4.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
						.addBox(-32.0F, 0.0F, -2.0F, 17.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 18).addBox(-32.0F, 0.0F, 1.0F, 17.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(24.0F, 2.0F, 0.0F));
		PartDefinition toparea = bone.addOrReplaceChild("toparea",
				...
				PartPose.offset(-24.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r1 = bone2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(8, 30).addBox(0.0F, 0.0F, -1.0F, 2.0F, 20.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2618F));
		PartDefinition backright = legs.addOrReplaceChild("backright", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r2 = backright.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 30).addBox(-2.0F, -1.0F, -1.2F, 2.0F, 21.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.3491F));
