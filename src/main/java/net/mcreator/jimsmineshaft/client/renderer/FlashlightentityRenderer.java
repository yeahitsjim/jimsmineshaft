...
public class FlashlightentityRenderer extends HumanoidMobRenderer<FlashlightentityEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	...
	public FlashlightentityRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(FlashlightentityEntity entity, HumanoidRenderState state, float partialTicks) {
