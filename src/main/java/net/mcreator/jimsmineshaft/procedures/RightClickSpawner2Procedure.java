...
if (
entity == null ) return ;
Direction workingDirection = Direction.NORTH;String workingRoomPick = "";com.google.gson.JsonObject freshCoordsJSON = new com.google.gson.JsonObject();
JimsmineshaftModVariables.filledSpaces.addProperty("x", (entity.getX()));JimsmineshaftModVariables.filledSpaces.addProperty("y", (entity.getY()-2));JimsmineshaftModVariables.filledSpaces.addProperty("z", (entity.getZ()));if (JimsmineshaftModItems.DELETED_MOD_ELEMENT.get() == (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem():ItemStack.EMPTY).getItem()) {if (0==JimsmineshaftModVariables.filledSpaces.get("x").getAsDouble()) {JimsmineshaftModVariables.filledSpaces.addProperty("x", (entity.getX()));}if (0==JimsmineshaftModVariables.filledSpaces.get("y").getAsDouble()) {JimsmineshaftModVariables.filledSpaces.addProperty("y", (entity.getY()));}if (0==JimsmineshaftModVariables.filledSpaces.get("z").getAsDouble()) {JimsmineshaftModVariables.filledSpaces.addProperty("z", (entity.getZ()));}workingRoomPick = ;if (!world.isClientSide() && world.getServer() != null)
world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("\u00A76Coords moved to: x: "+(new java.text.DecimalFormat("##.##").format(JimsmineshaftModVariables.filledSpaces.get("x").getAsDouble())+""+("y: "+(new java.text.DecimalFormat("##.##").format(JimsmineshaftModVariables.filledSpaces.get("y").getAsDouble())+""+("z: "+new java.text.DecimalFormat("##.##").format(JimsmineshaftModVariables.filledSpaces.get("z").getAsDouble()))))))), false);if (!world.isClientSide() && world.getServer() != null)
world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("\u00A76Structure Spawned: \u00A7l"+workingRoomPick)), false);if (!world.isClientSide() && world.getServer() != null)
world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("\u00A77\u00A7oCurrent (past) Direction: "+(JimsmineshaftModVariables.MapVariables.get(world).currentDirection+""))), false);if (!world.isClientSide() && world.getServer() != null)
world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("\u00A77\u00A7oWorking Direction: "+(entity.getDirection()+""))), false);JimsmineshaftModVariables.MapVariables.get(world).currentDirection = entity.getDirection();
JimsmineshaftModVariables.MapVariables.get(world).syncData(world);
if (Direction.SOUTH == (entity.getDirection())) {if (("elevator2").equals(workingRoomPick)) {if (world instanceof ServerLevel _serverworld) {
...
}}}if (Direction.WEST == (entity.getDirection())) {if (("elevator2").equals(workingRoomPick)) {if (world instanceof ServerLevel _serverworld) {
StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("jimsmineshaft", "elevator2"));
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(JimsmineshaftModVariables.filledSpaces.get("x").getAsDouble(),JimsmineshaftModVariables.filledSpaces.get("y").getAsDouble(),JimsmineshaftModVariables.filledSpaces.get("z").getAsDouble()),
...
}}}if (Direction.EAST == (entity.getDirection())) {if (("elevator2").equals(workingRoomPick)) {if (world instanceof ServerLevel _serverworld) {
StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("jimsmineshaft", "elevator2"));
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(JimsmineshaftModVariables.filledSpaces.get("x").getAsDouble(),JimsmineshaftModVariables.filledSpaces.get("y").getAsDouble(),JimsmineshaftModVariables.filledSpaces.get("z").getAsDouble()),
...
}}}if (Direction.NORTH == (entity.getDirection())) {if (("elevator2").equals(workingRoomPick)) {if (world instanceof ServerLevel _serverworld) {
StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("jimsmineshaft", "elevator2"));
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(JimsmineshaftModVariables.filledSpaces.get("x").getAsDouble(),JimsmineshaftModVariables.filledSpaces.get("y").getAsDouble(),JimsmineshaftModVariables.filledSpaces.get("z").getAsDouble()),
