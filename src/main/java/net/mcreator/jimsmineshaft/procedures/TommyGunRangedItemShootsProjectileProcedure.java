...
public class TommyGunRangedItemShootsProjectileProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		{
			Entity _ent = entity;
			_ent.setYRot(entity.getYRot() + Mth.nextInt(RandomSource.create(), -10, 10));
			_ent.setXRot(entity.getXRot() + Mth.nextInt(RandomSource.create(), -6, 6));
