...
if (
entity == null ) return ;
if (==false) {if () {if (world instanceof ServerLevel _level) {
...
if ((entityiterator.getPersistentData().getString("ownedBy")).equals(entity.getDisplayName().getString())) {if(!entityiterator.level().isClientSide()) entityiterator.discard();}
}
