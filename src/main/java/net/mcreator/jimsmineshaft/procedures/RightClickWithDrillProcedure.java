...
if () {if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem():ItemStack.EMPTY).getItem() == JimsmineshaftModItems.DELETED_MOD_ELEMENT.get()) {if (JimsmineshaftModBlocks.RAW_COPPER_2.get() == (world.getBlockState(new BlockPos(entity.level().clip(new ClipContext(entity.getEyePosition(1f),entity.getEyePosition(1f)
