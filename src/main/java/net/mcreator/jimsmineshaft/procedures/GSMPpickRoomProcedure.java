...
public class GSMPpickRoomProcedure {
	public static com.google.gson.JsonObject execute(LevelAccessor world, boolean pc_localWorkingRoomIsBitpass, double pr_variantTokenspass, double x_pass2, double y_pass2, double z_pass2, String CBP_direction, String pr_localCurrentVariantpass,
			String pr_localLastGeneratedStructurepass) {
		if (CBP_direction == null || pr_localCurrentVariantpass == null || pr_localLastGeneratedStructurepass == null)
		...
		com.google.gson.JsonObject placementDependency = new com.google.gson.JsonObject();
		com.google.gson.JsonObject placementJSON = new com.google.gson.JsonObject();
		...
		String workingDirectionString = "";
		boolean repeatRoom = false;
		boolean localWorkingRoomIsBit = false;
		boolean cantPlace = false;
		placementJSON.addProperty("canPlaceBit", true);
		placementJSON.addProperty("canPlaceShaft", true);
		placementJSON.addProperty("canPlaceMainShaft", true);
		placementJSON.addProperty("canPlaceSRoom", true);
		placementJSON.addProperty("canPlaceMRoom", true);
		placementJSON.addProperty("canPlaceLRoom", true);
		placementJSON.addProperty("canPlaceSElevator", true);
		placementJSON.addProperty("canPlaceMElevator", true);
		placementJSON.addProperty("canPlaceLElevator", true);
		currentX = x_pass2;
		currentY = y_pass2;
		currentZ = z_pass2;
		workingDirectionString = CBP_direction;
		...
		placementJSON = CheckBlockPlacementProcedure.execute(world, currentX, currentY, currentZ, workingDirectionString);
		if (!world.isClientSide() && world.getServer() != null)
			world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("\u00A74JSON Returned from placement: " + placementJSON)), false);
		if (localVariantTokens > 0) {
			...
			if (true == localWorkingRoomIsBit) {
				...
				if (("a").equals(localCurrentVariant)) {
					if (placementJSON.get("canPlaceMainShaft").getAsBoolean()) {
						...
						cantPlace = true;
						if (!world.isClientSide() && world.getServer() != null)
							world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for room, skipping. "), false);
						passedDependency.addProperty("workingRoomPick", "null");
				...
				if (("b").equals(localCurrentVariant)) {
					if (placementJSON.get("canPlaceShaft").getAsBoolean()) {
				...
				if (4 <= repeatGambling) {
					...
					if (("a").equals(localCurrentVariant)) {
						if (placementJSON.get("canPlaceMainShaft").getAsBoolean()) {
							...
							cantPlace = true;
							if (!world.isClientSide() && world.getServer() != null)
								world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for main shaft, skipping. "), false);
							passedDependency.addProperty("workingRoomPick", "null");
							passedDependency.addProperty("variantTokens", localVariantTokens);
							passedDependency.addProperty("currentVariant", localCurrentVariant);
							return passedDependency;
					...
					if (("b").equals(localCurrentVariant)) {
						if (placementJSON.get("canPlaceShaft").getAsBoolean()) {
							...
							cantPlace = true;
							if (!world.isClientSide() && world.getServer() != null)
								world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for Type B Shaft, skipping"), false);
							passedDependency.addProperty("workingRoomPick", "null");
							passedDependency.addProperty("variantTokens", localVariantTokens);
							passedDependency.addProperty("currentVariant", localCurrentVariant);
							return passedDependency;
						}
						if (placementJSON.get("canPlaceBit").getAsBoolean()) {
							...
							cantPlace = true;
							if (!world.isClientSide() && world.getServer() != null)
								world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for Type B Bit, skipping "), false);
							passedDependency.addProperty("workingRoomPick", "null");
							passedDependency.addProperty("variantTokens", localVariantTokens);
							passedDependency.addProperty("currentVariant", localCurrentVariant);
							return passedDependency;
					...
					if (("c").equals(localCurrentVariant)) {
						if (placementJSON.get("canPlaceShaft").getAsBoolean()) {
							...
							cantPlace = true;
							if (!world.isClientSide() && world.getServer() != null)
								world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for Type C shaft, skipping "), false);
							passedDependency.addProperty("workingRoomPick", "null");
							passedDependency.addProperty("variantTokens", localVariantTokens);
							passedDependency.addProperty("currentVariant", localCurrentVariant);
							return passedDependency;
			...
			if (("c").equals(localCurrentVariant)) {
				...
				if (placementJSON.get("canPlaceBit").getAsBoolean()) {
					...
					cantPlace = true;
					if (!world.isClientSide() && world.getServer() != null)
						world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for Type C Bit, skipping "), false);
					passedDependency.addProperty("workingRoomPick", "null");
					passedDependency.addProperty("variantTokens", localVariantTokens);
					passedDependency.addProperty("currentVariant", localCurrentVariant);
					return passedDependency;
		...
		if (placementJSON.get("canPlaceBit").getAsBoolean() == false) {
			if (!world.isClientSide() && world.getServer() != null)
				world.getServer().getPlayerList().broadcastSystemMessage(Component.literal("\u00A74No space for room, skipping. "), false);
			passedDependency.addProperty("workingRoomPick", "null");
			passedDependency.addProperty("variantTokens", localVariantTokens);
		...
		if (!world.isClientSide() && world.getServer() != null)
			world.getServer().getPlayerList().broadcastSystemMessage(
					Component.literal(("\u00A76Working room pick: \u00A7l" + (workingRoomPick + "" + ("\u00A7r\u00A76 Variant Tokens remaining: \u00A7l" + new java.text.DecimalFormat("##").format(localVariantTokens))))), false);
