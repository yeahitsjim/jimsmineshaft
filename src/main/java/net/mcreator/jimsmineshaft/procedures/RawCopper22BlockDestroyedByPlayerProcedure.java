...
public class RawCopper22BlockDestroyedByPlayerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		world.setBlock(BlockPos.containing(x, y, z), JimsmineshaftModBlocks.RAW_COPPER_23.get().defaultBlockState(), 3);
		if (letsgogambling == 1) {
