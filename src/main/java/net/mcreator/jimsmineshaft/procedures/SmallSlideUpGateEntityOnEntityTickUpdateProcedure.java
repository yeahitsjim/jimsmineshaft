...
public class SmallSlideUpGateEntityOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof SmallSlideUpGateEntityEntity _datEntL13 && _datEntL13.getEntityData().get(SmallSlideUpGateEntityEntity.DATA_open)) == true) {
			if ((entity instanceof SmallSlideUpGateEntityEntity _datEntL14 && _datEntL14.getEntityData().get(SmallSlideUpGateEntityEntity.DATA_opening)) == false) {
				...
				if (entity instanceof SmallSlideUpGateEntityEntity _datEntSetL)
					_datEntSetL.getEntityData().set(SmallSlideUpGateEntityEntity.DATA_opening, true);
			}
		} else {
			if (entity instanceof SmallSlideUpGateEntityEntity _datEntSetL)
				_datEntSetL.getEntityData().set(SmallSlideUpGateEntityEntity.DATA_opening, false);
		}
		if ((entity instanceof SmallSlideUpGateEntityEntity _datEntL18 && _datEntL18.getEntityData().get(SmallSlideUpGateEntityEntity.DATA_open)) == false) {
			if ((entity instanceof SmallSlideUpGateEntityEntity _datEntL19 && _datEntL19.getEntityData().get(SmallSlideUpGateEntityEntity.DATA_opening2)) == false) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("jimsmineshaft:smalldoor")), SoundSource.PLAYERS, 1, 1);
					} else {
				...
				if (entity instanceof SmallSlideUpGateEntityEntity _datEntSetL)
					_datEntSetL.getEntityData().set(SmallSlideUpGateEntityEntity.DATA_opening2, true);
			}
		} else {
			if (entity instanceof SmallSlideUpGateEntityEntity _datEntSetL)
