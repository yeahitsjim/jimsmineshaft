...
public class RawCopper26BlockDestroyedByPlayerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		world.setBlock(BlockPos.containing(x, y, z), JimsmineshaftModBlocks.RAW_COPPER_27.get().defaultBlockState(), 3);
		if (letsgogambling == 1) {
