...
public class FlashlightentityOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (JimsmineshaftModParticleTypes.DELETED_MOD_ELEMENT.get()), x, y, z, (int) (entity.getPersistentData().getDouble("beamsize") * 10), (entity.getPersistentData().getDouble("beamsize") * 0.1),
