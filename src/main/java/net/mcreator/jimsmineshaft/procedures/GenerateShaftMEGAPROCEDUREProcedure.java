...
public class GenerateShaftMEGAPROCEDUREProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == JimsmineshaftModItems.WOE_MINESHAFT_BE_UPON_THE.get()) {
			...
			JimsmineshaftModVariables.MapVariables.get(world).syncData(world);
			JimsmineshaftModVariables.MapVariables.get(world).variantTokens = 6;
			JimsmineshaftModVariables.MapVariables.get(world).syncData(world);
							...
							if (4 > branchOddsGambling) {
								...
								if (workingDirectionChangeBoolean == true) {
									if (currentSavedBranchCount == 0) {
										...
										savedBranch1.addProperty("workingDirection", workingDirection);
										savedBranch1.remove("currentDirection");
										savedBranch1.addProperty("currentDirection", JimsmineshaftModVariables.MapVariables.get(world).currentDirection);
									...
									if (currentSavedBranchCount == 1) {
										...
										savedBranch2.addProperty("workingDirection", workingDirection);
										savedBranch2.remove("currentDirection");
										savedBranch2.addProperty("currentDirection", JimsmineshaftModVariables.MapVariables.get(world).currentDirection);
