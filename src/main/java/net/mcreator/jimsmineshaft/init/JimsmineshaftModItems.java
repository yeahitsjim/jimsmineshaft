...
public class JimsmineshaftModItems {
	...
	public static final DeferredItem<Item> SKIN_STEALER_CHICKEN_NUGGET_AC_SPAWN_EGG = register("skin_stealer_chicken_nugget_ac_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_CHICKEN_NUGGET_AC.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_GOOBER_SPAWN_EGG = register("skin_stealer_goober_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_GOOBER.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_GIGO_SPAWN_EGG = register("skin_stealer_gigo_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_GIGO.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_GOSHIGGY_SPAWN_EGG = register("skin_stealer_goshiggy_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_GOSHIGGY.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_KUNZY_SPAWN_EGG = register("skin_stealer_kunzy_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_KUNZY.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_WYLAN_SPAWN_EGG = register("skin_stealer_wylan_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_WYLAN.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_YOUR_NOT_LUIS_SPAWN_EGG = register("skin_stealer_your_not_luis_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_YOUR_NOT_LUIS.get(), properties));
	public static final DeferredItem<Item> SKIN_STEALER_COW_MAN_5000_SPAWN_EGG = register("skin_stealer_cow_man_5000_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_COW_MAN_5000.get(), properties));
	public static final DeferredItem<Item> PLAYER_STALKIER_CHICKEN_NUGGET_AC_SPAWN_EGG = register("player_stalkier_chicken_nugget_ac_spawn_egg",
			properties -> new SpawnEggItem(JimsmineshaftModEntities.PLAYER_STALKIER_CHICKEN_NUGGET_AC.get(), properties));
	public static final DeferredItem<Item> COPPER_ORE_ENTITY_BOTTOM_BLOCK = block(JimsmineshaftModBlocks.COPPER_ORE_ENTITY_BOTTOM_BLOCK);
	public static final DeferredItem<Item> PLAYER_REVIVE_TOTEM = register("player_revive_totem", PlayerReviveTotemItem::new);
	public static final DeferredItem<Item> CLERK_BASIC_GOODS_2_BLOCK = block(JimsmineshaftModBlocks.CLERK_BASIC_GOODS_2_BLOCK);
	public static final DeferredItem<Item> SKIN_STEALER_ENTITY_2_SPAWN_EGG = register("skin_stealer_entity_2_spawn_egg", properties -> new SpawnEggItem(JimsmineshaftModEntities.SKIN_STEALER_ENTITY_2.get(), properties));
